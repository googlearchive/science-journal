...
public class ProxyRecorderController extends IRecorderController.Stub {
  ...
  private RecorderController.ObservedIdsListener proxyObservedIdsListener(
      final IRecordingStateListener listener, final FailureListener failureListener) {
  ...
  private static SensorStatusListener proxyStatusListener(
      final ISensorStatusListener listener, final FailureListener failureListener) {
