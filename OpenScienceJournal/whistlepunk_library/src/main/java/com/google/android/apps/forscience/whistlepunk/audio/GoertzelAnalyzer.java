...
class GoertzelAnalyzer {
    ...
    /**
     * Applies a series of Goertzel filters to frequencies near the given frequency estimate,
     * and returns the frequency with the highest power
     */
    double findFrequencyWithHighestPower(short[] samples, double frequencyEstimate) {
        ...
        do {
            ...
            double greatestPower, frequencyWithGreatestPower,
                    secondGreatestPower, frequencyWithSecondGreatestPower;
        ...
        return (powerAtLoFrequency > powerAtHiFrequency)
